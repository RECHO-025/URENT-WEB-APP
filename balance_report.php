                        ...
                        <div class="row">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $wallet_balances = [];
                                    $wallet_query = "SELECT tenant_id, SUM(amount) as wallet_amount FROM wallet";
                                    ...
                                    // FIXED: Get ALL unpaid payments, not just those created in the selected month
                                    $payment_query = "SELECT p.id AS payment_id, p.tenant_id, p.amount, p.InvoiceType, 
                                        ...
                                        FROM payments p 
                                        WHERE p.shopid = '$landlordid' AND p.pay_status = 0";

...
<!--
function showResult56(tenantid)
{
if (tenantid=="")
  {
  document.getElementById("txtHint56").innerHTML="";
  return;
  }
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("txtHint56").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","invoice_type.php?tenantid="+tenantid,true);
xmlhttp.send(); 
}
</script>
...
<div class="modal fade" id="registration_modal" role='dialog'>
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Landlord Registration</h5>
